...
2. Talk about 3 different things you can do to ensure your website is accessible.
   ...
   2. Make your fonts responsive so they can be enlarged for some users.
   3. Keep color contrast sensitivity in mind! (color schemes for color blind)

3. How would you explain the concept of a variable to someone new to programming?

A variable holds data. You can assign the data to the variable using keywords like Let, const and var.
